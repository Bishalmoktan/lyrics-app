      ...
      <div className="bg-white/5 backdrop-blur-lg rounded-3xl p-8 md:p-12 shadow-xl max-w-4xl w-full flex flex-col md:flex-row gap-8">
        <div className="flex-1 space-y-6">
          <div className="space-y-2">
            <h1 className="text-4xl font-bold text-white">Welcome to BISARIC</h1>
            <p className="text-xl text-white/80">Step into the rhythm of music with a single click.</p>
          </div>
          <div className="space-y-">
            ...
            >
              ...
              <Image src="/google.png" alt="Google" width={30} height={30} className="" />
              </div>
              Continue with Google
            </Button>
            <p className="text-sm text-white/60 text-center">
              {`Don't want to sign in?`}
              <Link href="/" className="text-rose-400 hover:text-rose-300 transition-colors duration-300">
                Continue as guest
              </Link>
            </p>
          </div>
        ...
        <div className="flex-1 space-y-8">
          <div>
            <h2 className="text-2xl font-semibold text-white mb-4">Why Sign In?</h2>
            <ul className="space-y-3">
              {[
                { icon: Music, text: "Access your personalized playlists" },
                { icon: FastForward, text: "Enjoy uninterrupted song navigation" },
                { icon: LayoutDashboard, text: "Experience our beautiful UI dashboard" },
                { icon: UserPlus, text: "Connect with friends and share music" },
              ].map((feature, index) => (
          ...
          <div className="bg-white/10 rounded-xl p-4">
            ...
            <p className="text-white/80">
              Sign in now to unlock exclusive features and elevate your music experience!
            </p>
          </div>
        </div>
      </div>
